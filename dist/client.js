...
exports.AISearchAPIClient = void 0;
...
class AISearchAPIClient {
    ...
    async search(request) {
        ...
        try {
            ...
            throw new types_1.AISearchAPIError(`Search request failed: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    /**
    ...
    async balance() {
        ...
        try {
            ...
            throw new types_1.AISearchAPIError(`Balance request failed: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    /**
    ...
    async makeRequest(url, options) {
        ...
        try {
            ...
            if (error.name === 'AbortError') {
                throw new types_1.AISearchAPIError(`Request timeout after ${this.timeout}ms`);
            }
            throw error;
        }
    }
    ...
    async handleErrorResponse(response) {
        ...
        throw new types_1.AISearchAPIError(errorMessage, response.status, errorData);
    }
    /**
...
exports.AISearchAPIClient = AISearchAPIClient;
